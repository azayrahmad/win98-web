...
// 	const svgDoc1 = await fetchSVG("/win98-web/apps/paint/images/modern/tools-dark.svg");
// 	const svgDoc2 = await fetchSVG("/win98-web/apps/paint/images/modern/tools.svg");
...
(async () => {
	console.log(await applyLabels("/win98-web/apps/paint/images/classic/tools.svg", "/win98-web/apps/paint/images/dark/tools.svg"));
})();
