...
async function init_tracky_mouse_ui() {
	...
	// block for indentation to avoid confusing git diff
	{
		if (!tracky_mouse_deps_promise) {
			TrackyMouse.dependenciesRoot = "/win98-web/apps/paint/lib/tracky-mouse/core";
		...
		const $tracky_mouse_window = $Window({
			title: "Tracky Mouse",
			icon: await load_image_simple("/win98-web/apps/paint/images/tracky-mouse-16x16.png"),
		});
		...
		icon.src = "/win98-web/apps/paint/images/tracky-mouse-16x16.png";
		icon.width = 16;
		icon.height = 16;
