...
const createWindow = () => {
	...
	editor_window = new BrowserWindow({
		...
		minWidth: 260,
		minHeight: 360,
		icon: path.join(__dirname, "/win98-web/apps/paint/images/icons",
...
// [2] I've tested this by dragging onto the //win98-web/apps/paint/lib/jspaint/jspaint binary so far.
